...
const MovieModal = ({ isModalOpen, movie, modalClose }) => {
    ...
    return (
        <Modal
            ...
            className="max-w-full w-auto max-h-full mx-4 sm:mx-0 p-8 bg-white rounded-3xl shadow-xl outline-none overflow-auto"
            overlayClassName="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center"
        >
            <div className="flex flex-col md:flex-row gap-8 md:max-w-5xl w-full">
                {/* Movie Image */}
                <img
                    src={movie.Poster}
                    alt={movie.Title}
                    className="w-full md:w-64 h-96 object-cover rounded-xl shadow-2xl transition duration-300 ease-in-out"
                />
